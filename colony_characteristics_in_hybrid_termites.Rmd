...
## * data loading
```{r}
s_sex_ratio_f <- read_excel("dataset1.xlsx", sheet="Figure 2a") %>% 
  as.data.frame(.)
...
Ra_hist <-
  ggplot(s_sex_ratio %>% filter(species == "R. amamianus"), aes(x = soldier_sex_ratio)) + 
...
```{r}
Rs_hist <-
  ggplot(s_sex_ratio %>% filter(species == "R. speratus"), aes(x = soldier_sex_ratio)) + 
  geom_histogram(boundary = 0, binwidth = binwidth, fill="black", color="white") +
  scale_x_continuous(breaks = seq(0, 1, by = 0.1), lim = c(0,1), expand = c(0,0)) +
  scale_y_continuous(breaks = seq(0, 10, by = 2), lim = c(0,7), expand = c(0,0)) +
  labs(x = "numerical sex ratio in soldiers (female ratio)",
...
## * data loading
```{r}
s_sex_ratio_l <- read_excel("dataset1.xlsx", sheet="Fig2b, Fig3a, Fig4a") %>% 
  as.data.frame(.) %>% 
...
## * data loading
```{r}
s_sex_ratio_l2 <- read_excel("dataset1.xlsx", sheet="Fig2c, Fig3b, Fig4b") %>% 
  as.data.frame(.) %>% 
  separate(cross_type, sep = "_", c("father_species", "mother_species")) %>% 
  mutate(cross_type = paste(father_species, mother_species, sep="_")) %>% 
...
## * data loading
```{r}
s_ratio_l <- read_excel("dataset1.xlsx", sheet="Fig2b, Fig3a, Fig4a") %>% 
  as.data.frame(.) %>% 
  separate(cross_type, sep = "_", c("father_species", "mother_species")) %>% 
  mutate(cross_type = paste(father_species, mother_species, sep="_")) %>% 
  mutate(number_of_soldiers = number_of_male_soldiers+number_of_female_soldiers) %>% 
...
## * data loading
```{r}
s_ratio_l2 <- read_excel("dataset1.xlsx", sheet="Fig2c, Fig3b, Fig4b") %>% 
  as.data.frame(.) %>% 
  separate(cross_type, sep = "_", c("father_species", "mother_species")) %>% 
  mutate(cross_type = paste(father_species, mother_species, sep="_")) %>% 
  mutate(number_of_soldiers = number_of_male_soldiers+number_of_female_soldiers) %>% 
...
## * data loading
```{r}
w_number <- read_excel("dataset1.xlsx", sheet="Fig2b, Fig3a, Fig4a") %>% 
  as.data.frame(.) %>% 
  separate(cross_type, sep = "_", c("father_species", "mother_species")) %>% 
  mutate(cross_type = paste(father_species, mother_species, sep="_"))
```
...
## * data loading
```{r}
w_number2 <- read_excel("dataset1.xlsx", sheet="Fig2c, Fig3b, Fig4b") %>% 
  as.data.frame(.) %>% 
  separate(cross_type, sep = "_", c("father_species", "mother_species")) %>% 
  mutate(cross_type = paste(father_species, mother_species, sep="_"))
```
...
## * data loading
```{r}
survival_rate <- read_excel("dataset1.xlsx", sheet="Figure 5") %>% 
  as.data.frame(.) %>% 
...
## * data loading
```{r}
w_sex_ratio <- read_excel("dataset1.xlsx", sheet="Figure 5") %>% 
  as.data.frame(.)
...
## * data loading
```{r}
s_sex_ratio_1 <- read_excel("dataset2.xlsx", sheet="FigS1a") %>% 
  as.data.frame(.)
...
## * data loading
```{r}
age_comp <- read_excel("dataset2.xlsx", sheet="FigS1b_c_d") %>% 
  as.data.frame(.) %>% 
  mutate(number_of_soldiers = number_of_male_soldiers+number_of_female_soldiers) %>% 
  mutate(soldier_sex_ratio = number_of_female_soldiers/number_of_soldiers) %>% 
  mutate(soldier_proportion = number_of_soldiers/number_of_workers)
